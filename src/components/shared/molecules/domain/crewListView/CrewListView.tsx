            ...
            <ul>
              {members.map((member) => {
                ...
                if (
                  ...
                  Object.keys(dietaryRestrictionsIcon).includes(member.dietary_restrictions)
                ) {
                  memberDietaryRestrictionsIcon =
                    dietaryRestrictionsIcon[member.dietary_restrictions as keyof typeof dietaryRestrictionsIcon];
                }
