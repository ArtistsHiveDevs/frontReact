...
import { useReportClaimSlice } from '~/common/slices/domain/reportClaim';
import {
  selectReportClaimError,
  selectReportClaimLoading,
  selectReportClaimSuccess,
} from '~/common/slices/domain/reportClaim/selectors';
import { ReportClaimErrorType, ReportClaimEntityType } from '~/common/slices/domain/reportClaim/types';
