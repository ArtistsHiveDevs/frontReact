  ...
  app: {
      ...
      entities: {
        ...
        users: {
          ...
          attributes: {
            ...
            gender_identity: {
              label: 'Gehörst du der LGBTIQ+-Community an?',
              values: {
                yes: 'Ja',
                no: 'Nein',
    ...
    pages: {
              ...
              sections: {
                music_performance: {
                  ...
                  attributes: {
                    ...
                    gender: 'Geschlecht',
                    gender_identity: 'Gehörst du der LGBTIQ+-Community an?',
                    email: 'E-Mail',
                    stage_name: 'Künstlername',
                  },
                },
      ...
      OpenCallDetailsPage: {
        ...
        missing_documents_title: 'Unvollständiges Profil',
        ...
        presentation: {
          open_badge: 'Offen',
          expired_badge: 'Geschlossen',
          apply_deadline_title: 'Bewerbungszeitraum',
          event_date_label: 'Veranstaltungsdatum',
          minutes_suffix: 'Min.',
          no_documents: 'Keine Dokumente angehängt',
          sections: {
            venue: 'Veranstaltungsort',
            about: 'Worum es geht',
            conditions: 'Bedingungen und Anforderungen',
            technical: 'Technische Details',
            compensation: 'Vergütung und Logistik',
            documents: 'Dokumente',
          },
          fields: {
            description: 'Beschreibung',
            ...
            expected_audience: 'Erwartetes Publikum',
            stage_type: 'Bühnentyp',
            stage_dimensions: 'Bühnenmaße',
            provided_sound: 'Bereitgestellter Ton',
            provided_backline: 'Bereitgestelltes Backline',
            provided_lighting: 'Bereitgestellte Beleuchtung',
            technical_notes: 'Technische Hinweise',
            fee: 'Gage',
            travel_support: 'Reisekostenzuschuss',
            accommodation_provided: 'Unterkunft',
            meals_provided: 'Verpflegung',
