  ...
  app: {
      ...
      entities: {
        ...
        users: {
          ...
          attributes: {
            ...
            gender_identity: {
              label: 'Você pertence à comunidade LGBTIQ+?',
              values: {
                yes: 'Sim',
                no: 'Não',
    ...
    pages: {
              ...
              sections: {
                music_performance: {
                  ...
                  attributes: {
                    ...
                    gender: 'Gênero',
                    gender_identity: 'Você pertence à comunidade LGBTIQ+?',
                    email: 'E-Mail',
                    stage_name: 'Nome artístico',
                  },
                },
      ...
      OpenCallDetailsPage: {
        ...
        presentation: {
          open_badge: 'Aberta',
          expired_badge: 'Fechada',
          apply_deadline_title: 'Prazo para candidatura',
          event_date_label: 'Data do evento',
          minutes_suffix: 'min',
          no_documents: 'Nenhum documento anexado',
          sections: {
            venue: 'Local',
            about: 'Sobre esta convocatória',
            conditions: 'Condições e requisitos',
            technical: 'Detalhes técnicos',
            compensation: 'Compensação e logística',
          ...
          fields: {
            ...
            stage_type: 'Tipo de palco',
            stage_dimensions: 'Dimensões do palco',
            provided_sound: 'Som fornecido',
            provided_backline: 'Backline fornecido',
            provided_lighting: 'Iluminação fornecida',
            technical_notes: 'Notas técnicas',
            fee: 'Cachê',
            travel_support: 'Apoio de viagem',
            accommodation_provided: 'Alojamento',
            meals_provided: 'Refeições',
        ...
        actions: {
          accept: 'Aceitar',
          reject: 'Rejeitar',
          complete_profile: 'Completar o perfil',
        },
      },
    },
    appbase: {
