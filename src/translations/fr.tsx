    ...
    global_dictionary: {
      ...
      actions: {
        accounts: {
          ...
          username_or_email_placeholder: "Entrez votre e-mail ou nom d'utilisateur",
        },
        create: 'Créer',
        edit: 'Modifier',
      ...
      errors: {
        ...
        VALIDATION_PASSWORD_NEEDS_NUMBER: 'Le mot de passe doit contenir au moins un chiffre',
        VALIDATION_PASSWORD_NEEDS_LOWERCASE: 'Le mot de passe doit contenir au moins une minuscule',
        VALIDATION_PASSWORD_NEEDS_UPPERCASE: 'Le mot de passe doit contenir au moins une majuscule',
        VALIDATION_PASSWORD_NEEDS_SPECIAL_CHAR: 'Le mot de passe doit contenir au moins un caractère spécial',
