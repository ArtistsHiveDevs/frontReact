    ...
    global_dictionary: {
      ...
      actions: {
        accounts: {
          ...
          username_or_email_placeholder: 'Inserisci la tua email o il tuo nome utente',
        },
        create: 'Crea',
        edit: 'Modificare',
        follow_us: 'Seguici',
      ...
      errors: {
        ...
        VALIDATION_PASSWORD_MIN_LENGTH: 'La password deve contenere almeno 8 caratteri',
        VALIDATION_PASSWORD_NEEDS_NUMBER: 'La password deve contenere almeno un numero',
        VALIDATION_PASSWORD_NEEDS_LOWERCASE: 'La password deve contenere almeno una lettera minuscola',
        VALIDATION_PASSWORD_NEEDS_UPPERCASE: 'La password deve contenere almeno una lettera maiuscola',
        VALIDATION_PASSWORD_NEEDS_SPECIAL_CHAR: 'La password deve contenere almeno un carattere speciale',
