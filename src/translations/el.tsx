  ...
  app: {
    ...
    global_dictionary: {
      ...
      place_types: {
        ...
        outdoor: 'Υπαίθριος χώρος',
        other: 'Άλλο',
      },
      actions: {
        accounts: {
          confirm_password: 'Επιβεβαίωση κωδικού',
          confirm_password_placeholder: 'Επιβεβαιώστε τον κωδικό σας',
          ...
          username_or_email_placeholder: 'Εισάγετε το email ή το όνομα χρήστη σας',
        },
        create: 'Δημιουργία',
        edit: 'εκδίδω ',
      ...
      errors: {
        ...
        VALIDATION_PASSWORD_MIN_LENGTH: 'Ο κωδικός πρέπει να έχει τουλάχιστον 8 χαρακτήρες',
        VALIDATION_PASSWORD_NEEDS_NUMBER: 'Ο κωδικός πρέπει να περιέχει τουλάχιστον έναν αριθμό',
        VALIDATION_PASSWORD_NEEDS_LOWERCASE: 'Ο κωδικός πρέπει να περιέχει τουλάχιστον ένα πεζό γράμμα',
        VALIDATION_PASSWORD_NEEDS_UPPERCASE: 'Ο κωδικός πρέπει να περιέχει τουλάχιστον ένα κεφαλαίο γράμμα',
        VALIDATION_PASSWORD_NEEDS_SPECIAL_CHAR: 'Ο κωδικός πρέπει να περιέχει τουλάχιστον έναν ειδικό χαρακτήρα',
