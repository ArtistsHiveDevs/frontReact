      ...
      entities: {
        ...
        users: {
          ...
          attributes: {
            ...
            gender_identity: {
              label: 'Ανήκεις στην κοινότητα LGBTIQ+;',
              values: {
                yes: 'Ναι',
                no: 'Όχι',
    ...
    pages: {
      ...
      domain: {
        CalendarPage: {
          ...
          empty_state: 'Δεν υπάρχουν εκδηλώσεις σε αυτό το εύρος ημερομηνιών',
          error: 'Παρουσιάστηκε σφάλμα κατά τη φόρτωση του ημερολογίου σας. Δοκιμάστε ξανά.',
          deadline_label: 'Προθεσμία',
          all_day: 'Ολοήμερο',
          filters: {
            title: 'Εμφάνιση στο ημερολόγιο',
          },
          types: {
            activity: 'Δραστηριότητες',
            opencall: 'Προθεσμίες ανοιχτών προσκλήσεων',
            event: 'Εκδηλώσεις',
            holiday: 'Αργίες',
          },
          meta: {
            expired: 'Ληγμένη ανοιχτή πρόσκληση',
            city: 'Πόλη',
          ...
          actions: {
            ...
            agenda: 'Ατζέντα',
            filters: 'Φίλτρα',
            create_activity: 'Δημιουργία δραστηριότητας',
            delete: 'Διαγραφή',
            cancel: 'Άκυρο',
          },
          activity_form: {
            create_title: 'Νέα δραστηριότητα',
            edit_title: 'Επεξεργασία δραστηριότητας',
            save_error: 'Η δραστηριότητα δεν μπόρεσε να αποθηκευτεί. Δοκιμάστε ξανά.',
            image_upload_error: 'Η εικόνα δεν μπόρεσε να μεταφορτωθεί. Δοκιμάστε ξανά.',
            fields: {
              title: 'Τίτλος',
              subtype: 'Τύπος',
              all_day: 'Ολοήμερο',
              ...
              end_time: 'Ώρα λήξης',
              notes: 'Σημειώσεις',
              image: 'Εικόνα εκδήλωσης',
            },
            subtypes: {
              rehearsal: 'Πρόβα',
              soundcheck: 'Ηχητική δοκιμή',
            ...
            validation: {
              title_required: 'Ο τίτλος είναι υποχρεωτικός',
              start_date_required: 'Η ημερομηνία έναρξης είναι υποχρεωτική',
              start_time_required: 'Η ώρα έναρξης είναι υποχρεωτική',
              end_date_required: 'Η ημερομηνία λήξης είναι υποχρεωτική',
            },
            delete_confirmation: {
              title: 'Διαγραφή δραστηριότητας',
              message: 'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτή τη δραστηριότητα; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.',
            },
          },
        },
        CulturalAgenda: {
              ...
              sections: {
                music_performance: {
                  ...
                  attributes: {
                    ...
                    gender: 'Φύλο',
                    gender_identity: 'Ανήκεις στην κοινότητα LGBTIQ+;',
                    email: 'Email',
                    stage_name: 'Καλλιτεχνικό όνομα',
                  },
                },
      ...
      OpenCallDetailsPage: {
        ...
        missing_documents_title: 'Ελλιπές προφίλ',
        missing_documents_message:
          'Για να υποβάλεις αίτηση στην πρόσκληση, πρέπει να συμπληρώσεις το προφίλ καλλιτέχνη σου με τις παρακάτω πληροφορίες',
        unauthorized_message: 'Συνδέσου για να υποβάλεις αίτηση σε αυτήν την πρόσκληση.',
        owner_switch_message:
          'Είσαι ιδιοκτήτης του {placeName}, αλλά περιηγείσαι με άλλο προφίλ. Άλλαξε προφίλ για να δεις τις αιτήσεις που έχεις λάβει για αυτήν την πρόσκληση.',
        switch_to_place_button: 'Αλλαγή στο προφίλ του χώρου',
        or_switch_to_artist_message: 'Ή αλλαγή σε ένα από τα προφίλ καλλιτέχνη σου:',
        not_artist_profile_message:
          'Για να υποβάλεις αίτηση σε αυτήν την πρόσκληση πρέπει να είσαι σε προφίλ καλλιτέχνη. Επίλεξε ένα:',
        no_artist_memberships_message: 'Δεν έχεις κανένα προφίλ καλλιτέχνη συνδεδεμένο με τον λογαριασμό σου.',
        go_to_industry_button: 'Διεκδίκηση ή δημιουργία προφίλ καλλιτέχνη',
        back_button: 'Πίσω στις προσκλήσεις μου',
        apply_button: 'Υποβολή αίτησης',
        open_call_status: {
          DRAFT: 'Πρόχειρο',
          OPEN: 'Ανοιχτή',
          CLOSED: 'Κλειστή',
        ...
        presentation: {
          open_badge: 'Ανοιχτή',
          expired_badge: 'Κλειστή',
          apply_deadline_title: 'Προθεσμία υποβολής αιτήσεων',
          event_date_label: 'Ημερομηνία εκδήλωσης',
          minutes_suffix: 'λεπτά',
          no_documents: 'Δεν υπάρχουν συνημμένα έγγραφα',
          sections: {
            venue: 'Χώρος',
            about: 'Σχετικά με αυτήν την πρόσκληση',
            conditions: 'Όροι και προϋποθέσεις',
            technical: 'Τεχνικές λεπτομέρειες',
            compensation: 'Αμοιβή και υλικοτεχνική υποστήριξη',
            documents: 'Έγγραφα',
          },
          fields: {
            ...
            expected_audience: 'Αναμενόμενο κοινό',
            stage_type: 'Τύπος σκηνής',
            stage_dimensions: 'Διαστάσεις σκηνής',
            provided_sound: 'Παρεχόμενος ήχος',
            provided_backline: 'Παρεχόμενο backline',
            provided_lighting: 'Παρεχόμενος φωτισμός',
            technical_notes: 'Τεχνικές σημειώσεις',
            fee: 'Αμοιβή',
            travel_support: 'Κάλυψη μετακίνησης',
            accommodation_provided: 'Διαμονή',
        ...
        actions: {
          accept: 'Αποδοχή',
          reject: 'Απόρριψη',
          complete_profile: 'Συμπλήρωση προφίλ',
        },
      },
    },
    appbase: {
