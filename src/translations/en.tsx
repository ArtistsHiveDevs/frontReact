    ...
    global_dictionary: {
      ...
      actions: {
        accounts: {
          ...
          username_or_email_placeholder: 'Enter your email or username',
        },
        create: 'Create',
        edit: 'Edit',
        follow_us: 'Follow us',
      ...
      errors: {
        ...
        VALIDATION_PASSWORD_NEEDS_NUMBER: 'Password must contain at least one number',
        VALIDATION_PASSWORD_NEEDS_LOWERCASE: 'Password must contain at least one lowercase letter',
        VALIDATION_PASSWORD_NEEDS_UPPERCASE: 'Password must contain at least one uppercase letter',
        VALIDATION_PASSWORD_NEEDS_SPECIAL_CHAR: 'Password must contain at least one special character',
