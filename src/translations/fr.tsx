  ...
  app: {
      ...
      entities: {
        ...
        users: {
          ...
          attributes: {
            ...
            gender_identity: {
              label: 'Appartenez-vous à la communauté LGBTIQ+ ?',
              values: {
                yes: 'Oui',
                no: 'Non',
    ...
    pages: {
              ...
              sections: {
                music_performance: {
                  ...
                  attributes: {
                    ...
                    gender: 'Genre',
                    gender_identity: 'Appartenez-vous à la communauté LGBTIQ+ ?',
                    email: 'E-Mail',
                    stage_name: 'Nom de scène',
                  },
                },
      ...
      OpenCallDetailsPage: {
        ...
        missing_documents_title: 'Profil incomplet',
        ...
        presentation: {
          open_badge: 'Ouvert',
          expired_badge: 'Fermé',
          apply_deadline_title: 'Période de candidature',
          event_date_label: "Date de l'événement",
          minutes_suffix: 'min',
          no_documents: 'Aucun document joint',
          sections: {
            venue: 'Lieu',
            about: 'À propos de cet appel',
            conditions: 'Conditions et exigences',
            technical: 'Détails techniques',
            compensation: 'Rémunération et logistique',
            documents: 'Documents',
          },
          fields: {
            description: 'Description',
            ...
            expected_audience: 'Public attendu',
            stage_type: 'Type de scène',
            stage_dimensions: 'Dimensions de la scène',
            provided_sound: 'Son fourni',
            provided_backline: 'Backline fourni',
            provided_lighting: 'Éclairage fourni',
            technical_notes: 'Notes techniques',
            fee: 'Cachet',
            travel_support: 'Prise en charge des déplacements',
            accommodation_provided: 'Hébergement',
            meals_provided: 'Repas',
