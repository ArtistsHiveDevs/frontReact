    ...
    global_dictionary: {
      ...
      actions: {
        accounts: {
          ...
          username_or_email_placeholder: 'Gib deine E-Mail oder deinen Benutzernamen ein',
        },
        create: 'Erstellen',
        edit: 'Bearbeiten',
        follow_us: 'Folge uns',
      ...
      errors: {
        ...
        VALIDATION_PASSWORD_MIN_LENGTH: 'Das Passwort muss mindestens 8 Zeichen lang sein',
        VALIDATION_PASSWORD_NEEDS_NUMBER: 'Das Passwort muss mindestens eine Zahl enthalten',
        VALIDATION_PASSWORD_NEEDS_LOWERCASE: 'Das Passwort muss mindestens einen Kleinbuchstaben enthalten',
        VALIDATION_PASSWORD_NEEDS_UPPERCASE: 'Das Passwort muss mindestens einen Großbuchstaben enthalten',
        VALIDATION_PASSWORD_NEEDS_SPECIAL_CHAR: 'Das Passwort muss mindestens ein Sonderzeichen enthalten',
