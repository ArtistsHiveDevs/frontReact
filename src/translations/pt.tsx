  ...
  app: {
    ...
    global_dictionary: {
      ...
      place_types: {
        ...
        club: 'Clube',
        theater: 'Teatro',
        concert_hall: 'Casa de espetáculos',
      ...
      actions: {
        accounts: {
          ...
          username_or_email_placeholder: 'Digite seu e-mail ou nome de usuário',
        },
        create: 'Criar',
        edit: 'Editar',
        follow_us: 'Siga-nos',
      ...
      errors: {
        ...
        VALIDATION_PASSWORD_MIN_LENGTH: 'A senha deve ter pelo menos 8 caracteres',
        VALIDATION_PASSWORD_NEEDS_NUMBER: 'A senha deve conter pelo menos um número',
        VALIDATION_PASSWORD_NEEDS_LOWERCASE: 'A senha deve conter pelo menos uma letra minúscula',
        VALIDATION_PASSWORD_NEEDS_UPPERCASE: 'A senha deve conter pelo menos uma letra maiúscula',
        VALIDATION_PASSWORD_NEEDS_SPECIAL_CHAR: 'A senha deve conter pelo menos um caractere especial',
