  ...
  app: {
      ...
      entities: {
        ...
        users: {
          ...
          attributes: {
            ...
            gender_identity: {
              label: 'Appartieni alla comunità LGBTIQ+?',
              values: {
                yes: 'Sì',
                no: 'No',
    ...
    pages: {
              ...
              sections: {
                music_performance: {
                  ...
                  attributes: {
                    ...
                    gender: 'Genere',
                    gender_identity: 'Appartieni alla comunità LGBTIQ+?',
                    email: 'E-Mail',
                    stage_name: "Nome d'arte",
                  },
                },
      ...
      OpenCallDetailsPage: {
        ...
        missing_documents_title: 'Profilo incompleto',
        ...
        presentation: {
          open_badge: 'Aperto',
          expired_badge: 'Chiuso',
          apply_deadline_title: 'Periodo di candidatura',
          event_date_label: "Data dell'evento",
          minutes_suffix: 'min',
          no_documents: 'Nessun documento allegato',
          sections: {
            venue: 'Location',
            about: 'Di cosa si tratta',
            conditions: 'Condizioni e requisiti',
            technical: 'Dettagli tecnici',
            compensation: 'Compenso e logistica',
            documents: 'Documenti',
          },
          fields: {
            description: 'Descrizione',
            ...
            expected_audience: 'Pubblico previsto',
            stage_type: 'Tipo di palco',
            stage_dimensions: 'Dimensioni del palco',
            provided_sound: 'Impianto audio fornito',
            provided_backline: 'Backline fornito',
            provided_lighting: 'Illuminazione fornita',
            technical_notes: 'Note tecniche',
            fee: 'Cachet',
            travel_support: 'Supporto per i viaggi',
            accommodation_provided: 'Alloggio',
            meals_provided: 'Pasti',
