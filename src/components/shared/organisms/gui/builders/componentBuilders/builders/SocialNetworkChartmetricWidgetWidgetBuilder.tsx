import { SocialNetworksAnalyticsWidget } from '~/components/shared/domain/organisms/SocialNetworksAnalyticsWidget';
...
export const createSocialNetworkChartmetricAnalyticsWidgetComponent = (params: ComponentBuilderParams): JSX.Element => {
  ...
  return (
    <>
      <SocialNetworksAnalyticsWidget columns={4} />
    </>
  );
};
