    ...
    global_dictionary: {
      ...
      actions: {
        accounts: {
          ...
          username_or_email_placeholder: 'Ingresa tu email o nombre de usuario',
        },
        create: 'Crear',
        edit: 'Editar',
        follow_us: 'Síguenos',
      ...
      errors: {
        ...
        VALIDATION_PASSWORD_MIN_LENGTH: 'La contraseña debe tener al menos 8 caracteres',
        VALIDATION_PASSWORD_NEEDS_NUMBER: 'La contraseña debe contener al menos un número',
        VALIDATION_PASSWORD_NEEDS_LOWERCASE: 'La contraseña debe contener al menos una minúscula',
        VALIDATION_PASSWORD_NEEDS_UPPERCASE: 'La contraseña debe contener al menos una mayúscula',
        VALIDATION_PASSWORD_NEEDS_SPECIAL_CHAR: 'La contraseña debe contener al menos un carácter especial',
