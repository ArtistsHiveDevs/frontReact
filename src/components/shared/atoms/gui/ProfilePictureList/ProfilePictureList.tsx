  ...
  return (
    <div>
      ...
      {entities.map((entityName: string) => {
        ...
        return (
          <div key={entityName}>
            <div className="ppl-entity-type-participants">
              {isEditable ? (
                <>
                  <FormLabel required={true} error={missingParticipant} className="ppl-entity-type-participants">
